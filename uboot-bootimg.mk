...
PRODUCT_VERSION = Classicnerd-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)$(PRODUCT_VERSION_DEVICE_SPECIFIC)
...
INTERNAL_RECOVERYRAMDISK_IMAGENAME := Classicnerd $(TARGET_DEVICE) Ramdisk
...
ifeq ($(BOARD_USES_UBOOT_MULTIIMAGE),true)
    $(warning We are here.)
    INTERNAL_RECOVERYIMAGE_IMAGENAME := Classicnerd $(TARGET_DEVICE) Multiboot
